...
export default function ReleaseCalendar({
  ...
  const handleSaveRelease = useCallback(() => {
    ...
    if (editingRelease) {
      setReleases((prev) =>
        prev.map((r) => (r.id === editingRelease.id ? releaseData : r))
      );
          ...
          <div className="flex items-center justify-between max-w-7xl mx-auto">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Press ESC to exit • Use view toggle to switch between timeline
                and calendar
              </p>
            </div>
            ...
            <div className="space-y-8">
              ...
              {(() => {
                ...
                return releaseMonths.map((monthStr) => {
                  ...
                  const monthReleases = sortedReleases.filter(
                    (r) =>
                  ...
                  for (let i = 0; i < 42; i++) {
                    // 6 weeks * 7 days
                    const dayReleases = monthReleases.filter(
                      (r) =>
                    ...
                    >
                      ...
                      <div className="grid grid-cols-7 gap-3 mb-4">
                        {[
                          ...
                          <div
                            key={day}
                            className="text-center text-lg font-semibold text-gray-400 py-3"
                          >
                            {day}
                          </div>
                        ))}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData((prev) => ({
                          ...prev,
                          status: e.target.value as Release["status"],
                        }))
                      }
                      className="w-full rounded-md border-0 bg-white/5 px-3 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 text-sm"
                    >
